...
게임을 실행하면 나오는 타이틀 화면입니다. 입장 버튼을 누르면 꿈 전시관으로 들어가는 컷신과 함께 게임이 시작됩니다.<br><br>
...
설정 버튼을 누르면 설정 화면이 표시되며, 이곳에서 초당 프레임 제한, 해상도, 마우스 감도, 언어, 사운드 크기를 변경할 수 있습니다. 그리고 변경된 설정 값들은 컴퓨터에 파일로 저장되기 때문에, 게임이 종료되어도 설정이 그대로 유지됩니다. 게임이 시작된 후에도 ESC 키를 눌러 설정 화면을 띄울 수 있습니다.<br><br>
...
연기가 걷히고 나면 갑자기 강아지가 짖기 시작합니다. 이 강아지는 괴물이 들어오려 하는 창문을 향해 짖는 것으로, 괴물의 침입을 막으려면 플레이어는 해당 창문을 닫으러 가야 합니다.<br><br>
...
건물을 내려가는 중간 중간마다 안전 구역이 배치되어 있습니다.
...
안전 구역 내부에는 플레이어를 감지해서 켜지는 조명이 설치되어 있습니다.
...
안전 구역 끝의 갈림길에서 왼쪽으로 가면 '용감한 도전자' 엘리베이터를 탈 수 있고, 오른쪽으로 가면 '슈퍼 겁쟁이' 엘리베이터를 탈 수 있습니다.
...
선택한 엘리베이터의 버튼을 눌러서 다음 장소로 이동할 수 있습니다.
...
'용감한 도전자' 엘리베이터를 탈 경우, 여러가지 도전을 할 수 있는 서커스장에 도착하게 됩니다.
...
플레이어는 외줄을 건너는 동안 좌우 키를 눌러서 외발자전거의 균형을 잡아야 합니다.
앞서가는 광대를 참고하면 좀 더 쉽게 성공할 수 있습니다.
...
그리고 동시에 닫혀있던 왕관 모양 엘리베이터가 열리면서 서커스장을 나갈 수 있게 됩니다.
